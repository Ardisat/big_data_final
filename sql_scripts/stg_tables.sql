...
CREATE TABLE "p3"."ENV_STG_DEL_PASSPORT_BLACKLIST" ("passport_num" varchar(255) NOT NULL);
...
CREATE TABLE "p3"."ENV_STG_DEL_TRANSACTIONS" ("trans_id" varchar(255) NOT NULL);
...
CREATE TABLE "p3"."ENV_STG_DEL_ACCOUNTS" ("account" varchar(255) NOT NULL);
